...
#Read the data:
data_dir <- "data"
TrainingData = read.csv(file.path(data_dir, "TrainingData.csv"))
SubmissionZeros = read.csv(file.path(data_dir, "SubmissionZerosExceptNAs.csv"))
...
write.csv(submission_hour_means_NAs, file.path(data_dir, "submission_hour_means.csv"), row.names = FALSE)
...
write.csv(submission_hour_chunk_means_NAs, file.path(data_dir, "submission_hour_chunk_means.csv"), row.names = FALSE)
